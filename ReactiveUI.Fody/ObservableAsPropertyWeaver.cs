    ...
    public class ObservableAsPropertyWeaver
    {
        ...
        public void Execute()
        {
            ...
            var exceptionDefinition = systemRuntimeName == null
                ? ModuleDefinition.ImportReference(typeof(Exception)).Resolve() // .NET Framework
                : ModuleDefinition.AssemblyResolver.Resolve(systemRuntimeName).MainModule.Types.First(x => x.Name == "Exception"); // .NET Standard
